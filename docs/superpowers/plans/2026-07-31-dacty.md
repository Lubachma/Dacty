...
- Node ≥ 20, npm.
- Corpus : 30 textes libres (ids `xx-001`..`xx-030`, dont 5 avec `quote: true`) + 10 officiels Challenger (ids `xx-101`..`xx-110`) par langue (`fr`, `en`). Longueurs : short 110-200 car., medium 320-480 car., long 650-950 car.
